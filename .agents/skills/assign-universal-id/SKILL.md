...
- [ ] Mỗi `feature:*` có dòng `> Implements: prd:*` không?
...
| ID | Implements | Bước |
|----|------------|------|
| `task:setup-project-0001` | `prd:tech-stack-0002` | Khởi tạo dự án |
| `task:build-grid-ui-0002` | `feature:product-grid-0001` | Dựng lưới sản phẩm |
| `task:add-search-0003` | `feature:search-filter-0002` | Thêm bộ lọc |
